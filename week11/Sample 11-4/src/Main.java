...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String[][] employees = {{"홍길동", "1111"}, {"강민성", "1211"}, {"김명성", "2111"},
                {"박건준", "1441"},{"오유빈", "1444"},{"니키타", "1456"},{"한정호", "1678"},
                {"파마트", "1567"},{"이예린", "1789"},{"제이넵", "1787"}};
       ...
       int[][] salarys = new int[employees.length][5];  //기본급, 업무수당, 급여액, 세금, 지급액
        ...
        for (i = 0; i < employees.length; i++) {
            switch (hobong[i]) {
                ...
                case 5 :
                    ...
                    break;
                default:
                    salarys[i][0] = 0;      //0이 들어가면 잘못됐다는 의미
            }
        }
        ...
        System.out.println("************************************************************************");
        System.out.println(" 이름   사번   호봉    기본금    업무수당    급여액       세금     지급액     비고");
        System.out.println("************************************************************************");

        for (i = 0; i < employees.length; i++) {
            System.out.printf("%4s %5s %2d %,10d %,9d %,9d %,8d %,9d\n", employees[i][0], employees[i][1],
