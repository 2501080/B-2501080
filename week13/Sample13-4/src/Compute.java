public class Compute {
    public static void pay(int[] money, String[] customers, float v) {
        int used = (int) (v + 0.5f);
        if (customers[2].equals("1")) {
            money[0] = used * 40 + 1200;
        } else if (customers[2].equals("2")) {
            money[0] = used * 55 + 1200;
        } else if (customers[2].equals("3")) {
            money[0] = used * 78 + 1200;
        } else if (customers[2].equals("4")) {
            money[0] = used * 35 + 1200;
        } else if (customers[2].equals("5")) {
